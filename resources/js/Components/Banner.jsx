                        ...
                        <div className="flex flex-col-reverse justify-center lg:flex-row">
                            <div className>
                                <img
                                    ...
                                    className="hidden h-full lg:block md:block"
                                />
                                <img
                            ...
                            <div className="h-auto bg-black">
                                <div className="px-4 py-6 lg:py-10 md:py-10">
                                    <p className="text-base leading-none text-center text-white">
                                        #lookgoodfeelgood
                                    </p>
                                    <p className="py-3 text-3xl font-semibold leading-9 text-center text-white md:text-4xl">
                                        Brand Deal of the Month
                                    </p>
                                    <p className="py-3 text-2xl leading-normal text-center text-white">
                                        Get up to 20% off
                                    </p>
